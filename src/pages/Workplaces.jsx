...
function Workplaces() {
  ...
  const getWorkplaces = async () => {
    ...
    try {
      ...
      // axios.get( `${import.meta.env.VITE_API_URL}/api/workplaces` ); - We replace the previous, import.meta for the one we created on services.
...
//accepts a function and an array - We want to call this function when we mount the component - Load the page, get workplaces and never get them again unless we edit or delete.
